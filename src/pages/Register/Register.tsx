...
//     Slide, // For slide transitions
// } from '@mui/material';
// import { styled } from '@mui/system'; // For custom styled components
// import { keyframes } from '@emotion/react'; // For custom keyframe animations
// import loginPhoto from '../../assets/images/login.jpg';
// import { Visibility, VisibilityOff } from '@mui/icons-material';
// import ImageIcon from '@mui/icons-material/Image';
// import { Link, useNavigate } from 'react-router-dom';
...
// // Create a styled component for the main form container
// const AnimatedFormContainer = styled(Box)(({ theme }) => ({
//     display: 'flex',
//     width: '100%',
//     maxWidth: '1000px',
//     minHeight: '600px',
...
// // Create a styled component for the form box
...
//                 paddingRight: '8px',
//                 paddingLeft: '8px',
//                 // Add a transition to the form fields
//                 '& .MuiTextField-root': {
...
//                     />
//                 </Grid>
//                 <Slide direction="right" in={!isTeacher} mountOnEnter unmountOnExit>
//                     <Grid item xs={12}>
//                         <TextField
//                             fullWidth
//                             select
...
//                     </Grid>
//                 </Slide>
//                 <Slide direction="left" in={isTeacher} mountOnEnter unmountOnExit>
//                     <Grid item xs={12}>
//                         <TextField
//                             fullWidth
//                             select
...
//                                 '&:hover': {
//                                     borderColor: '#1976d2',
//                                     boxShadow: '0px 0px 8px rgba(25, 118, 210, 0.2)',
//                                 },
//                             }}
//                         >
//                             {imagePreview ? (
...
//                     backgroundSize: 'cover',
//                     backgroundPosition: 'center',
//                     animation: `${fadeIn} 1s ease-out 0.5s both`, // Add a delay for staggered animation
//                     display: { xs: 'none', sm: 'block' } // Hide on small screens for better responsiveness
//                 }} />
//             </AnimatedFormContainer>
//             <Dialog open={showWaitingPopup} onClose={handleCloseDialog}>
//                 <DialogTitle>بانتظار المراجعة</DialogTitle>
...
// Define keyframe animations for various UI elements
const fadeIn = keyframes`
...
// Styled component for the main form container with entrance animation
const AnimatedFormContainer = styled(Box)(({ theme }) => ({
    display: 'flex',
    width: '100%',
    maxWidth: '1000px',
...
// Styled component for the form box with a slide-in animation
const FormBox = styled(Box)(({ theme }) => ({
    flex: 1,
    display: 'flex',
    flexDirection: 'column',
...
// Styled component for the Google sign-in button with a shimmer effect
const GoogleButton = styled(Button)(({ theme }) => ({
    transition: 'all 0.3s ease-in-out',
    background: `linear-gradient(to right, ${theme.palette.primary.main} 0%, ${theme.palette.primary.dark} 50%, ${theme.palette.primary.main} 100%)`,
